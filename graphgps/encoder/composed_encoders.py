...
from graphgps.encoder.kernel_pos_encoder import RWSENodeEncoder, \
    HKdiagSENodeEncoder, ElstaticSENodeEncoder, DegreecentralityEncoder, RandomEncoder, NodecentralityEncoder
...
pe_encs = {'LapPE': LapPENodeEncoder,
           ...
           'DegreeCentrality': DegreecentralityEncoder,
           'NodeCentrality': NodecentralityEncoder,
...
for ds_enc_name, ds_enc_cls in ds_encs.items():
    register_node_encoder(
        f"{ds_enc_name}+Random+DegreeCentrality",
        concat_node_encoders([ds_enc_cls, RandomEncoder, DegreecentralityEncoder],
                             ['Random', 'DegreeCentrality'])
    )
