...
def set_cfg_posenc(cfg):
    ...
    for name in ['posenc_LapPE', 'posenc_SignNet',
                 'posenc_RWSE', 'posenc_HKdiagSE', 'posenc_ElstaticSE', 'posenc_DegreeCentrality']:
    ...
    for name in ['posenc_RWSE', 'posenc_HKdiagSE', 'posenc_ElstaticSE', 'posenc_DegreeCentrality']:
        pecfg = getattr(cfg, name)
